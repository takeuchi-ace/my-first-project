...
export const events: GameEvent[] = [
...

  {
    ...
    choices: [
      ...
      { text: '「○○さんの柔軟性、すごいですね！プロ並みですよ！！全財産賭けてもいい！！」と感激しすぎる', delta: { fun: 9, trust: -3, creep: 14 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
    id: 'tee_time_waiting',
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「ゴルフ歴20年というのは、今日の神プレーへの前振りですか！？もはや生ける伝説！！！」と大げさに崇め奉る', delta: { fun: 10, trust: -2, creep: 15 }, tags: ['flattery', 'extreme'] },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「ブラックですか？ミルクですか？砂糖は？甘さは何段階で？豆の種類は？」と細かく聞きすぎる', delta: { fun: 5, trust: -1, creep: 8 }, tags: ['over_support', 'extreme'] },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: '「今の素振り…PGAのプロと見分けがつきません！あなたこそが本物の天才です！！」と叫ぶ', delta: { fun: 9, trust: -4, creep: 16 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
    id: 'handicap_inquiry',
    ...
    choices: [
      ...
      { text: '「ハンデ？そんなもの○○さんの前では意味がありません！今日はとにかく先生と呼ばせてください！！」と土下座する勢いで言う', delta: { fun: 8, trust: -3, creep: 13 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
    id: 'glove_compliment',
    ...
    choices: [
      ...
      { text: '「そのグローブに包まれた手で放たれたショットは、きっと伝説になる…！神の一打を待っています！」と詩人のように語る', delta: { fun: 7, trust: -2, creep: 12 }, tags: ['flattery', 'extreme'] },
    ],
  },
...

  {
    ...
    choices: [
      ...
      { text: '相手のボトルを開けて持ち歩き、打つたびに飲み物を差し出し続け、最終的に専属ドリンクキャリアーと化す', delta: { fun: 7, trust: -3, creep: 12 }, tags: ['over_support', 'extreme'] },
    ],
  },
  {
    id: 'bad_lie_reaction',
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「その一打で今日のラウンドを制した…もはやゴルフの神降臨！！後で御神体として祀らせてください！！！」とひれ伏す', delta: { fun: 10, trust: -5, creep: 17 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「OK！あれは入りました！！ゴルフの神様も絶対そう思っています！！記録はバーディで！！」と強引にOKを出す', delta: { fun: 7, trust: -4, creep: 14 }, tags: ['cheat_score', 'extreme'] },
    ],
  },
  {
...

  {
    ...
    choices: [
      ...
      { text: '「今のショット…全世界のバンカー苦手な人に見せてあげたい…これが本物のゴルフだ…！涙が止まらない！！」と泣きそうになる', delta: { fun: 8, trust: -3, creep: 13 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: '「○○さんはキャディさんすら感化する！その信頼関係こそが真のリーダーシップ！！本を出してください！！」と熱弁する', delta: { fun: 8, trust: -4, creep: 15 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「そのスライスは天才の証！フェードボールと呼べばプロ仕様！スライスとは呼ばせません！！アートです！！！」とスライスを芸術に昇格させる', delta: { fun: 9, trust: -3, creep: 14 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
    id: 'opponent_yips',
...

  {
    ...
    choices: [
      ...
      { text: '「今のホールは集計よりプレー内容の方が大事ですよ！あの5番アイアン、完璧でした！」と計算よりプレーを称える', delta: { fun: 5, trust: 2 }, tags: ['flattery'] },
    ],
  },
  {
    id: 'greenside_drama',
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「今から膝専門のドクターを呼びます！！プレーより膝が大事！！コースドクター、今すぐ来てください！！！」と大騒ぎする', delta: { fun: 8, trust: -5, creep: 15 }, tags: ['over_support', 'extreme'] },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: '「自分の読みより○○さんの感覚を信じてください！20年の経験には勝てません！」と引き立てる', delta: { fun: 4, trust: 3 }, tags: ['flattery'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「このコースに謝れ！いや、○○さんの腕があればコースは関係ない！！コースの方が恐縮しているはずです！！」と訳のわからない理屈で庇う', delta: { fun: 9, trust: -4, creep: 14 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
...

  {
    ...
    choices: [
      ...
      { text: '「○○さんが選んだものが一番美味しいに決まってます！食の審美眼まで超一流！！シェフが泣いて喜ぶ！！！」と崇拝する', delta: { fun: 8, trust: -4, creep: 15 }, tags: ['flattery', 'extreme'] },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「飲みながらプレーする○○さん、最高にカッコいい！！これがリアルビジネスゴルフ！一緒に飲めて光栄です！！」と大興奮で飲む', delta: { fun: 9, trust: -2, focus: -8, creep: 11 }, tags: ['alcohol', 'flattery', 'extreme'] },
    ],
  },
  {
    id: 'lunch_topic_golf',
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「○○さんが飲むならもちろん！100杯でも付き合います！！肝臓を○○さんに捧げます！！！」と豪語する', delta: { fun: 9, trust: -3, focus: -10, creep: 12 }, tags: ['alcohol', 'flattery', 'extreme'] },
    ],
  },
  {
    id: 'rest_room_wait',
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「今日の後半は○○さんにとって歴史的なラウンドになります！！後世に語り継がれる伝説の午後！！！録画しておくべきでした！！」と宣言する', delta: { fun: 10, trust: -3, creep: 13 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
...

  {
    ...
    choices: [
      ...
      { text: '「今のホールインワン！！ゴルフの神様が嫉妬した結果がカップを外れた！！あなたが真のホールインワン・マスター！！生涯忘れません！！」とおかしなことを叫ぶ', delta: { fun: 10, trust: -5, creep: 16 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
    id: 'tough_putt_read',
    ...
    choices: [
      ...
      { text: '「絶対左です！！○○さんの直感は神の啓示！！迷わずプロセスを信じてください！！！」と根拠なく断言する', delta: { fun: 7, trust: -3, creep: 12 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「この美しい景色も○○さんのゴルフがあってこそ輝いている…大自然も接待ゴルフを心得ている！！」と壮大な解釈を押しつける', delta: { fun: 8, trust: -4, creep: 13 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「OK！！イーグル確定！！ゴルフの歴史にその名が刻まれる日が来ました！！今すぐ銘板を発注します！！！」と勝手に決める', delta: { fun: 10, trust: -5, creep: 18 }, tags: ['cheat_score', 'extreme'] },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: '自分のクラブを全部差し出し「全部使ってください！自分は素手でやります！！」と言う', delta: { fun: 7, trust: -2, creep: 11 }, tags: ['over_support', 'extreme'] },
    ],
  },
  {
    id: 'caddy_mistake',
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「自分もわざとミスしてスコアを合わせますよ！」とバレる嘘をつく', delta: { fun: 4, trust: -2, creep: 5 }, tags: ['humor'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「今から後半が始まりますが、○○さんの後半戦を見るためだけに今日来た気がします！！奇跡の大逆転劇、楽しみにしてます！！！」と圧をかける', delta: { fun: 9, trust: -4, creep: 13 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「プロのカメラマンを呼びましょうか！？○○さんには最高品質の記念写真が相応しい！！今すぐカメラマンを手配します！！！」と言い出す', delta: { fun: 8, trust: -3, creep: 13 }, tags: ['over_support', 'extreme'] },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: '「皆さん、今日の○○さんのプレーに注目してください！プロ顔負けのラウンドをご覧いただけます！！」とアナウンスする', delta: { fun: 7, trust: -4, creep: 12 }, tags: ['flattery', 'extreme'] },
    ],
  },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「今の一打で今日のラウンド代が全部ペイできた！！ゴルフの神が認めた一打！！この瞬間を目撃できた自分は幸運の極み！！！」と号泣しそうになる', delta: { fun: 10, trust: -4, creep: 16 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: '「センターど真ん中狙いで！○○さんのドライバーに不可能はない！！！」と根拠なく煽る', delta: { fun: 6, trust: 1, creep: 7 }, tags: ['flattery', 'bold'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「担架を呼びましょうか！！○○さんを絶対に運び続けます！！倒れても自分が背負います！！！」と大騒ぎする', delta: { fun: 8, trust: -4, creep: 13 }, tags: ['over_support', 'extreme'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「今日のプレーは完璧でした！全18ホール、教科書にできます！！記念碑を建てましょうか！！！」と熱弁する', delta: { fun: 8, trust: -4, creep: 14 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「このスコアは日本ゴルフ史上最高の内容です！！ゴルフ雑誌の表紙を飾るべきです！！担当者に今すぐ電話します！！！」と叫ぶ', delta: { fun: 10, trust: -5, creep: 17 }, tags: ['flattery', 'extreme'] },
    ],
  },
  {
    id: 'pro_shop_browse',
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '「来月！！毎月！！毎週でも！！365日○○さんと一緒にゴルフしたい！！もう離れたくない！！！」と依存心全開で叫ぶ', delta: { fun: 8, trust: -5, creep: 16 }, tags: ['over_support', 'extreme'] },
    ],
  },
  {
    id: 'bath_towel_offer',
